        ...
        <div className="log-bg">
                ...
                <div className="inner-ban-txt">
                    <ul>
                        ...
                        <li><Link href="javascript:void(0);"><a>Privacy policy</a></Link></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div className="box-section mg-t0">
                        <div className="fwid box-sec-01">
                            <div className="row-same-height columns is-mobile is-variable is-0">
                                <div className="fwid top-box bg-green is-fullwidth">
                                        ...
                                        <h1 className="box-head">Privacy policy </h1>
                                        </div>
                        ...
                        <div className="fwid bot-box">
                            <div className="fwid fm-white-top pd-30 has-text-grey about-sec">
                                ...
                                <p>This privacy policy sets out how  Coupon Arbitrage.com 
                                uses and protects any information that you give  Coupon Arbitrage.com 
                                when you use this website.</p>
                                <div className="fwid bot-box"><div className="fwid fm-white-top has-text-grey pd-30">
              <p>Coupon Arbitrage.com  is committed to ensuring that 
...
this privacy statement.</p>
              <p>Coupon Arbitrage.com  may change this policy from time 
...
effective from 31/03/2010.</p>
              <p><strong className="has-text-grey">What  we collect</strong></p>
              ...
              <ul><li>
                  ...
                  <p>other information relevant to customer surveys and/or offers</p></li></ul>
              <p><strong className="has-text-grey">What  we do with the information we gather</strong></p>
...
following reasons:</p>
              <ul><li>
                  ...
                  <p><span>We may  	periodically send promotional emails</span><span><strong className="has-text-grey"> </strong></span><span>about
 new products, special offers  	or other information which we think you 
may find interesting using  	the email address which you have provided. </span></p>
                </li><li>
                  <p><span>From time to  	time, we may also use your 
...
to customise the website according to  	your interests.</span></p></li></ul>
              <p><strong className="has-text-grey">Security</strong></p>
              <p><span>We  are committed to ensuring that your information is secure. In order  to prevent unauthorised access or disclosure,</span><span><strong className="has-text-grey"> </strong></span><span>we
...
procedures to safeguard and  secure the information we collect online.</span></p>
              <p><strong className="has-text-grey">How  we use cookies</strong></p><p><span >A  cookie is a small file which asks permission to be 
...
your  needs, likes and dislikes by gathering and remembering information
  about your preferences.</span></p>
              <p>We use  traffic log cookies to identify which pages are
 being used. This  helps us analyse data about web page traffic and 
improve our website  in order to tailor it to customer needs. We only 
use this information  for statistical analysis purposes and then the 
data is removed from  the system.</p>
              <p>Overall,  cookies help us provide you with a better 
...
with us.</p><p><span >You  can choose to accept or decline cookies. Most web 
...
from  taking full advantage of the website.</span></p>
              <p><strong className="has-text-grey">Links  to other websites</strong></p><p><span >Our  website may contain links to other websites of 
...
website  in question.</span></p>
              <p><strong className="has-text-grey">Controlling  your personal information</strong></p><p><span >You  may choose to restrict the collection or use of your personal  information in the following ways:</span></p>
              <ul><li>
                  <p>whenever  	you are asked to fill in a form on the 
...
purposes</p>
                  ...
                  <p>if you have  	previously agreed to us using your 
personal information for direct  	marketing purposes, you may change 
your mind at any time by writing  	to or emailing us at support@couponarbitrage.co.uk</p>
                </li></ul>
              <p>We  will not sell, distribute or lease your personal 
information to third  parties unless we have your permission or are 
required by law to do  so. We may use your personal information to send 
you promotional  information about third parties which we think you may 
find  interesting if you tell us that you wish this to happen.</p>
              <p>You  may request details of personal information which 
we hold about you  under the Data Protection Act 1998. A small fee will 
be payable. If  you would like a copy of the information held on you 
please email .</p>
              <p><span>If you believe that any  information we are 
