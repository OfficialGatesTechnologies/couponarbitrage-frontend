...
export default withRouter(class TurnoverNetellerEarning extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userData: [],
    ...
    getEarnings = (page) => {
        ...
        axios.defaults.headers.common['Authorization'] = jsCookie.get('jwtToken');
        let listUrl = apiUrl + 'account/neteller-earnings?pageLimit=' + pageLimit + '&page=' + page;
    ...
    render() {
        ...
        return (
            ...
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title> Neteller Cashback Transactions | {site_name} </title>
