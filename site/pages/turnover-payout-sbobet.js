...
toast.configure();
export default withRouter(class TurnoverPayoutSbobet extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userData: [],
            ...
            checkPayout: [],
            tb_type: '5b7a49f8049ac11419000051',
            scheme: 2,
            cashback_user_id: '',
        }
    }
    ...
    getEarnings = (page) => {
        ...
        axios.defaults.headers.common['Authorization'] = jsCookie.get('jwtToken');
        let listUrl = apiUrl + 'account/sbobet-earnings?pageLimit=' + pageLimit + '&page=' + page + '&tb_type=' + tb_type + '&scheme=' + scheme;
    ...
    handlePayoutSubmit = () => {
        ...
        axios.post(apiUrl + 'account/turnover-payout-request', {
            ...
            cashback_user_id: this.state.userBalance.sbobetId,
        }).then((result) => {
                                                        ...
                                                        this.state.loading ?
                                                            ...
                                                            this.state.arrList.length > 0
                                                                ...
                                                                : !this.state.userBalance ?
                                                                    <tr>
                                                                        <td colspan="5" style={{ textAlign: 'center' }}>
                                                                            Your 10 digit SBOBet user id not updated yet.
                                                             <Link href="/sbobet-cashback" as={`/sbobet-cashback`}><a className="has-green">Update Now.</a></Link></td>
                                                                    </tr> :
                                                                    <tr>
