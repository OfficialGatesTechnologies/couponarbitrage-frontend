...
export default withRouter(class TurnoverEcopayz extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userData: [],
    ...
    getEarnings = (page) => {
        ...
        axios.defaults.headers.common['Authorization'] = jsCookie.get('jwtToken');
        let listUrl = apiUrl + 'account/ecopayz-earnings?pageLimit=' + pageLimit + '&page=' + page;
    ...
    render() {
        ...
        return (
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title> Ecopayz Cashback Transactions | {site_name} </title>
