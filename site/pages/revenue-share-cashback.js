...
export default withRouter(class RevenueShareCashback extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offerList: [],
            loading: true,
            menuUrl: 'revenue-share-cashback',
            subcat: '',
            parentId: '',
            metaTitle: '',
            metakey: '',
                        ...
                        <div className="cbk-mid-banner">
                            <div className="columns">
                                <div className="column is-3">
                                    {
                                        this.state.parentId ? <TopTenOffers valueType="2" parentId={this.state.parentId} /> : ''
                                    }
                                </div>
                                <CashbackBanner />
                            </div>
                            ...
                            <div className="columns">
                                <div className="column is-9">
                                    ...
                                    <div className="cbk-clm-list">
                                        ...
                                        {
                                            this.state.parentId && this.state.listView == 'list' ? <CashbackListView valueType="2" loading={this.state.loading} menuUrl={this.state.menuUrl}  offerList={this.state.offerList} /> : ''
                                        }
                                        {
                                            this.state.parentId && this.state.listView == 'grid' ? <CashbackGridView valueType="2" loading={this.state.loading} menuUrl={this.state.menuUrl}  offerList={this.state.offerList} /> : ''
                                        }
                                    </div>
                                </div>
                                <div className="column is-3">
