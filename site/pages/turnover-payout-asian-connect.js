...
toast.configure();
export default withRouter(class TurnoverPayoutAsianConnect extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userData: [],
            ...
            checkPayout: [],
            tb_type: '5b7a49f8049ac1141900005d',
            scheme: 4,
            cashback_user_id: '',
        }
    }
    ...
    getEarnings = (page) => {
        ...
        axios.defaults.headers.common['Authorization'] = jsCookie.get('jwtToken');
        let listUrl = apiUrl + 'account/assianconnect-earnings?pageLimit=' + pageLimit + '&page=' + page + '&tb_type=' + tb_type + '&scheme=' + scheme;
    ...
    handlePayoutSubmit = () => {
        ...
        axios.post(apiUrl + 'account/turnover-payout-request', {
            ...
            cashback_user_id: this.state.userBalance.asianconnectId,
        }).then((result) => {
