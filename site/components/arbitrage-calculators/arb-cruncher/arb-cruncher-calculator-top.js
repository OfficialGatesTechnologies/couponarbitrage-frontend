                                ...
                                <div className="column is-6 col-md-height bg-white texts-box">
                                        <div className="fwid two-box">
                                            <div className="fwid learn-box learn-box-link">
                                             ...
                                             <p>The live online calculator is shown below and is also available in a convenient 
                                                 <Link href="#"><a id="popup_window"> popup window</a></Link></p>
                                             <p>To work out the calculations used for cross market arbitrage betting use the free
                                                 <Link href="/cross-market-arbitrage-calculator"><a> cross arbitrage calculator tool</a></Link></p>
                                             </div>
                                        </div>
