...
module.exports = routes()
    ...
    .add('sharbing-software', '/sharbing-software', 'sharbing-software')
    .add('affiliates', '/affiliates', 'affiliates')
    .add('affiliate-dashboard', '/affiliate-dashboard', 'affiliate-dashboard')
    .add('learn-sports-arbitrage', '/learn-sports-arbitrage', 'learn-sports-arbitrage')
    .add('learn-sports-arbitrage/:url_key', '/learn-sports-arbitrage/:url_key', 'learn-sports-arbitrage-whatissports')
    .add('article/:url_key', '/article/:url_key', 'article')
