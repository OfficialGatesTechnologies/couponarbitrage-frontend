...
const TurnoverSkrillEarning = (props) => (
    <div>
        <Head>
            <meta charSet="utf-8" />
            ...
            <div className="container">
                ...
                <table className="table new-table emptys-tables table is-fullwidth" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tbody className="has-text-grey border-td">
                              ...
                              <tr>
                                    <td colspan="3" style={{textAlign: 'center'}}>Your 12 digit NETELLER user id not updated yet.<Link href=""><a className="has-green">Update Now.</a></Link></td>
                              </tr>
                            </tbody>
                        </table>
                      </div>
...
export default TurnoverSkrillEarning;
