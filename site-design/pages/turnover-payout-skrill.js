...
const TurnoverPayoutSkrill = (props) => (
    <div>
        <Head>
            <meta charSet="utf-8" />
                    ...
                    <div className="column is-7">
                        ...
                        <div className="fwid texts-box">
                                    <div className="fwid free-arbs-menus">
                                        <ul role="tablist" className="no-style clearfix">
                                            <li className="active" role="presentation">
                                            <Link href="/turnover-payout-skrill"><a title="Skrill">Skrill</a></Link>
                                            </li>
                                            <li className="" role="presentation">
                ...
                <div className="table-sec table-responsive">
                        <table className="table new-table emptys-tables table is-fullwidth" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tbody className="has-text-grey border-td">
                              ...
                              <tr>
                              <td colspan="5" style={{textAlign: 'center'}}>Your 8 digit Skrill user id not updated yet. <Link href=""><a className="has-green">Update Now.</a></Link></td>
...
export default TurnoverPayoutSkrill;
