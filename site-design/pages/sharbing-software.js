 ...
 Chat with other members</li>
            ...
            <section id="FAQs" className="sections-sharb has-text-grey has-text-weight-light">
                <div className="container">
                    ...
                    <div className="custom_panel has-text-weight-light">
                        <div className="panel-group" id="accordion">
							<div className="panel panel-default">
								<div className="panel-heading">
									<h4 className="panel-title">
										<a className="accordtab current" data-toggle="AccordD1" data-parent="#accordion" href="#AccordD1">Which bookmakers/exchanges are supported for shop arbs?</a>
									</h4>
								</div>
								<div id="AccordD1" className="dsnone panel-collapse collapse in">
									<div className="panel-body">
										<p>Currently we provide sharbs for the following bookmakers:  Betfred, Coral, David Pluck, Ladbrokes, Paddy Power and William Hill. We search for sharbs between these bookmakers and the following exchanges: Betfair, Matchbook, Smarkets.</p>
									</div>
								</div>
							</div>
							<div className="panel panel-default">
								<div className="panel-heading">
									<h4 className="panel-title">
										<a className="accordtab" data-toggle="AccordD2" data-parent="#accordion" href="#AccordD2">What markets are covered on your service?</a>
									</h4>
								</div>
								<div id="AccordD2" className="dsnone panel-collapse collapse">
									<div className="panel-body">
										<p>Match Result, Both Teams to Score, HT/FT, Under/Over Goals, Correct Score, Win To Nil, 1st Goalscorer, Match Odds & BTTS and any other markets we can find in bookmaker shop coupons.</p>
									</div>
								</div>
							</div>
							<div className="panel panel-default">
								<div className="panel-heading">
									<h4 className="panel-title">
										<a className="accordtab" data-toggle="AccordD3" data-parent="#accordion" href="#AccordD3">Do you offer a free trial?</a>
									</h4>
								</div>
								<div id="AccordD3" className="dsnone panel-collapse collapse">
									<div className="panel-body">
										<p>Unfortunately not – As we are limiting the number of subscribers, we will not be offering free trials to the app. You can try our service for 1 week for £19.</p>
									</div>
								</div>
							</div>
							<div className="panel panel-default">
								<div className="panel-heading">
									<h4 className="panel-title">
										<a className="accordtab" data-toggle="AccordD4" data-parent="#accordion" href="#AccordD4">How can I pay for my subscription?</a>
									</h4>
								</div>
								<div id="AccordD4" className="dsnone panel-collapse collapse">
									<div className="panel-body">
										<p>We accept Paypal or Skrill payments. All payments are made securely.</p>
									</div>
								</div>
							</div>
							<div className="panel panel-default">
								<div className="panel-heading">
									<h4 className="panel-title">
										<a className="accordtab" data-toggle="AccordD5" data-parent="#accordion" href="#AccordD5">Will you teach me how to do shop arbs or sports arbitrage in general?</a>
									</h4>
								</div>
								<div id="AccordD5" className="dsnone panel-collapse collapse">
									<div className="panel-body">
										<p>Unfortunately we do not have the resources to spend time teaching you how to arb. You will find some useful articles in our ‘Learn Sports Arbitrage’ section but we cannot offer one-to-one training for free. Our service was designed to help existing sharbers or those with a basic knowledge to optimise their time and profits by removing the need to manually collect, compare and find arbs on bookmaker shop coupons.</p>
									</div>
								</div>
							</div>
							<div className="panel panel-default">
								<div className="panel-heading">
									<h4 className="panel-title">
										<a className="accordtab" data-toggle="AccordD6" data-parent="#accordion" href="#AccordD6">Do you limit the number of subscribers?</a>
									</h4>
								</div>
								<div id="AccordD6" className="dsnone panel-collapse collapse">
									<div className="panel-body">
										<p>We are very strict in only allowing 30 members at any one time in order to maintain value for everyone. If you subscribe now but all our places are full, your access to the sharbs will be activated once the next slot becomes available. Please contact us first if you want to enquire about availability. </p>
									</div>
								</div>
							</div>
						</div>
