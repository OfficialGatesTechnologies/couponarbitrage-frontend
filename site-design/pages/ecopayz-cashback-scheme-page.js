                                            ...
                                            <div className="container-inner xs-mg-0">
                                                <div className="demo">
                                                    <div className="sliderbox">
                                                        <input type="text" id="ex" value="" name="range" />
                                                    </div>
                                                    {/* <button className="button is-primary modal-button" id="myModal" data-target="#myModal" aria-haspopup="true">Launch example modal</button>

<div className="modal" id="myModal">
  <div className="modal-background"></div>
  <div className="modal-content">
    <div className="box">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean efficitur sit amet massa fringilla egestas. Nullam condimentum luctus turpis.        </div>
  </div>
  <button className="modal-close is-large" aria-label="close"></button>
                            ...
                            <div className="fwid tabdivsec-wrap">
                                    <div className="fwid tabdivsec-li"> <a className="accordtab" data-toggle="AccordDiv-1" href="javascript:void(0);">How does the Ecopayz Cashback Scheme Work?</a>
                                            <div className="dsnone maintabdiv" id="AccordDiv-1" style={{display: 'none'}}>
                                    The Ecopayz cashback scheme allows you to earn cashback on all your transactions using your&nbsp;Ecopayz&nbsp;account. All transactions qualify for cashback and the rate of cashback increases as you transfer more.&nbsp;<br/>        </div>
                                    </div>

                                    <div className="fwid tabdivsec-li"> <a className="accordtab" data-toggle="AccordDiv-2" href="javascript:void(0);">Who is eligible to join the Ecopayz Cashback Scheme?</a>
                                            <div className="dsnone maintabdiv" id="AccordDiv-2" style={{display: 'none'}}>
                                    Every&nbsp;new&nbsp;Ecopayz customer who registers via our link is eligible to join the scheme. For&nbsp;existing&nbsp;customers, please feel free to apply and Ecopayz will assess each application on a case-by-case basis which is usually dependant on whether you have been referred by another affiliate already and your recent activity on your account.        </div>
                                    </div>

                                    <div className="fwid tabdivsec-li"> <a className="accordtab " data-toggle="AccordDiv-3" href="javascript:void(0);">Are any merchants excluded from the Ecopayz cashback scheme?</a>
                                            <div className="dsnone maintabdiv" id="AccordDiv-3">
                                    All merchants are included therefore you will receive cashback on all your transactions with Ecopayz<br/>        </div>
                                    </div>
                                    <div className="fwid tabdivsec-li"> <a className="accordtab " data-toggle="AccordDiv-4" href="javascript:void(0);">Are any merchants excluded from the Ecopayz cashback scheme?</a>
                                            <div className="dsnone maintabdiv" id="AccordDiv-4">
                                    ...
                                    <div className="fwid tabdivsec-li"> <a className="accordtab " data-toggle="AccordDiv-5" href="javascript:void(0);">How does instant Gold VIP and fast-track verification work?</a>
                                            <div className="dsnone maintabdiv" id="AccordDiv-5">
                                    ...
                                    <div className="fwid tabdivsec-li"> <a className="accordtab " data-toggle="AccordDiv-6" href="javascript:void(0);">How often will my cashback stats be updated?</a>
                                            <div className="dsnone maintabdiv" id="AccordDiv-6">
