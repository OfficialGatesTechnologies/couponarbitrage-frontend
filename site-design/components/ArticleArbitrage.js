                    ...
                    <div className="fwid bg-white mg-t-40">
                        <div className="blog-list-cmd fwid">
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                <textarea placeholder="Comment" name="commentDesc" id="commentDesc_parent" class="input"></textarea>
                            ...
                            <div className="field">
                                ...
                                <input type="text" name="captchaCode" value="" id="captchaCode_parent" class="input numonly required"/> 
                                    
                                    <p class="has-text-danger err_msg" id="err_commentName_parent"></p>
                                </div>
                                <div className="control column">
                                <img src="static/images/captcha.jpg"/>
                                </div>
                                </div>
                                <div class="fwid sm-mg-t30"> 
                                            <div className="sign-bot"><div className="text-left">
                                                <button class="btn btn-default green-btn xm-full-btn" type="submit" name="commentSubmit" value="true">Send Comment</button>
                                                <button type="reset" class="btn btn-default purple-btn xm-full-btn">Cancel</button>
                                            </div></div>
                                        </div>
