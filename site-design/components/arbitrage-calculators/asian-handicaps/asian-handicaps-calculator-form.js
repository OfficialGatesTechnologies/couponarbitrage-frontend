            ...
            <div>
                ...
                <div className="fwid arb-cruncher bg-white mg-t-40">
                    <div className="arb-cruncher-head">
                        <h4>Asian Handicaps Calculator</h4>
                    </div>
                    ...
                    <tr>
                <td><span data-toggle="tooltip" title="" data-placement="right" className="tooltip is-tooltip-multiline is-tooltip-right has-text-grey" data-tooltip="Home to win by 4 or more. If won by 3 - whole stake will be returned.">AH -3</span>
              ...
              {/* AH-2.75 Section */}
              <tr>
                <td><span data-toggle="tooltip" title="" data-placement="right" className="tooltip is-tooltip-multiline is-tooltip-right has-text-grey" data-tooltip="Home to win by 4 or more. If won by 3 - half bet will be void, half wins.">AH-2.75</span>
                 <input type="hidden" id="h_cap_1" value="1" />
                <input type="hidden" id="h_cap_1_1" value="3.00" />
                 <input type="hidden" id="h_cap_2_1" value="None"/>
                 </td>
