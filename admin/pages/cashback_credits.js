...
export default withRouter(class Cashback_credits extends Component {
    ...
    getList = (page) => {
        ...
        let listUrl = apiUrl + 'admin/cashback-claims/credit-list?pageLimit=' + pageLimit + '&page=' + page;
    ...
    updateCategory = (action, id) => {
        ...
        if (updateStatus) {
            axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
            axios.post(apiUrl + 'admin/cashback-claims/update-cat-status', {
                action: action,
                _id: id,
            }).then((result) => {
    ...
    render() {
        return (
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title>{site_name} - Cashback Credits   </title>
                </Head>
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li className="is-active"><a href="#">Revenue Share cashback Claims</a></li>
                                        <li className="is-active"><a href="#">Cashback Credits   List</a></li>
                                    </ul>
                                    <Link href="/manage_cashback_credits">
                                        <a className="ad-new" >Add New Credits </a>
                                    </Link>
                                </nav>
                    ...
                    <div className="box is-shadowless has-background-white" >
                                                ...
                                                <div className="control">
                                                    ...
                                                    <div className="select is-fullwidth">
                                                        <select name="searchBy" onChange={this.handleInputChange}>
                                                            ...
                                                            <option value="revenueCreditType">Type</option>
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Cashback Credits    List </h2>
                                <div>
                            ...
                            <table className="table is-bordered is-striped is-narrow is-hoverable is-fullwidth is-size-6">
                                <thead>
                                    <tr className="bg-light">
                                        <th>#</th >
                                        <th>User</th>
                                        <th onClick={this.handleSort.bind(this, 'revenueCreditType', this.state.sortOrder)} >Type  <i className={`fa ${(this.state.sortKey == "revenueCreditType") ? this.state.sortClass : "fa-sort"}`}></i></th>
                                        <th >Amount</th>
                                        <th >Status</th>
                    ...
                    : (props.arrlist.length > 0) ?
                        props.arrlist.map(function (dataRow, i) {
                            ...
                            return <tr>
                                ...
                                <td>
                                    {
                                        dataRow.revenueCreditStatus === 1 ?
                                            <label className="tag is-info tooltip is-tooltip-bottom " data-tooltip="Approved ">
                                                Pending</label> : <label className="tag is-success tooltip is-tooltip-bottom " data-tooltip="Approved ">
                                                Paid</label>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_cashback_credits?id=${dataRow._id}`} as={`/manage_cashback_credits/${dataRow._id}`}>
