...
export default withRouter(class Articles extends Component {
    ...
    getList = (page) => {
        ...
        let listUrl = apiUrl + 'admin/article/list?pageLimit=' + pageLimit + '&page=' + page;
    ...
    updateAccount = (action, id) => {
        ...
        if (updateStatus) {
            axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
            axios.post(apiUrl + 'admin/article/update-articles-status', {
                action: action,
                _id: id,
            }).then((result) => {
                ...
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li className="is-active"><a href="#">Articles  List</a></li>
                                    </ul>
                                    <Link href="/manage_articles" as="manage_articles">
                                        <a className="ad-new" >Add New Article</a>
                                    </Link>
                                </nav>
                    ...
                    <div className="box is-shadowless has-background-white" >
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Articles   List </h2>
                                <div>
                            ...
                            <table className="table is-bordered is-striped is-narrow is-hoverable is-fullwidth is-size-6">
                                <thead>
                                    <tr className="bg-light">
                                        <th>#</th >
                                        <th onClick={this.handleSort.bind(this, 'title', this.state.sortOrder)} >Title <i className={`fa ${(this.state.sortKey == "title") ? this.state.sortClass : "fa-sort"}`}></i></th>
                                     
                                        <th onClick={this.handleSort.bind(this, 'added', this.state.sortOrder)} >Created On <i className={`fa ${(this.state.sortKey == "added") ? this.state.sortClass : "fa-sort"}`}></i></th>
                                        <th >Status</th>
                ...
                (props.loading) ?
                    ...
                    : (props.arrlist.length > 0) ?
                        props.arrlist.map(function (dataRow, i) {
                            ...
                            var enabledBtn = (dataRow.disabled == 0) ? true : false;
                            var disbaledBtn = (dataRow.disabled == 1) ? true : false;
                            ...
                            return <tr key={sNo + i}>
                                ...
                                <td>{dataRow.added.slice(0, 10)}</td>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_articles?id=${dataRow._id}`} as={`/update-article/${dataRow._id}`}>
