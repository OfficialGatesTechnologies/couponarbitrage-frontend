...
import {DyRouter} from '../routes'

export default withRouter(class manage_revenue_cashback_claims extends Component {
        ...
        axios.get(apiUrl + 'admin/cashback-claims/cliam-row?_id=' + editId)
            .then(res => {
                ...
                if (error) {
                   ...
                   Router.push(`/revenue_cashback_claims/unconfirmed`);
                }
            })
    }
    ...
    handleSubmit = (e) => {
        ...
        axios.post(apiUrl + 'admin/cashback-claims/update-claim', claimData).then((result) => {
           ...
           // DyRouter.pushRoute('/revenue_cashback_claims/unconfirmed');
            ...
            <div>
                ...
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li>
                                            <Link href="/revenue_cashback_claims?unconfirmed" as="/revenue_cashback_claims/unconfirmed" prefetch>
                                                <a href="#"> Revenue Share cashback List </a>
                                            </Link>
                                        </li>

                                        <li className="is-active"><a href="#">{this.state.editForm ? 'Edit' : "Add New"} Cashback Claims  </a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div className="box is-shadowless has-background-white" >
                        <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Cashback Claims    Info  </h2>
                        <hr></hr>
