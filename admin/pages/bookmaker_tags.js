...
export default withRouter(class Bookmaker_tags extends Component {
    ...
    getList = (page) => {
        ...
        let listUrl = apiUrl + 'admin/bookmaker/tag-list?pageLimit=' + pageLimit + '&page=' + page;
    ...
    updateTags = (action, id) => {
        ...
        if (updateStatus) {
            axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
            axios.post(apiUrl + 'admin/bookmaker/update-tag-status', {
                action: action,
                _id: id,
            }).then((result) => {
                        ...
                        <div className="column">
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    ...
                                    <Link href="/manage_bookmaker_tags">
                            ...
                            return <tr>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_bookmaker_tags?id=${dataRow._id}`} as={`/update_bookmaker_tags/${dataRow._id}`}>
