...
export default withRouter(class revenue_cashback_claims extends Component {
    ...
    render() {
        return (
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title>{site_name} - Revenue Share cashback  Claims  </title>
                </Head>
                            ...
                            return <tr>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_revenue_cashback_claims?id=${dataRow._id}`} as={`/manage_revenue_cashback_claims/${dataRow._id}`}>
