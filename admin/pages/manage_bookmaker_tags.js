...
export default withRouter(class manage_bookmaker_tags extends Component {
    ...
    getCatRow = (editId) => {
        ...
        axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
        axios.get(apiUrl + 'admin/bookmaker/tag-row?_id=' + editId)
            .then(res => {
    ...
    createSite = () => {
        const { tagData } = this.state;
        axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
        axios.post(apiUrl + 'admin/bookmaker/create-tag', {
            tagData: tagData,
        }).then((result) => {
    ...
    updateSite = () => {
        const { tagData } = this.state;
        axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
        axios.post(apiUrl + 'admin/bookmaker/update-tag', {
            tagData: tagData,
        }).then((result) => {
            let sucMsg = result.data.msg;
            toastr.success(sucMsg, '');
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li>
                                            <Link href="/bookmaker_tags" prefetch>
                                                <a href="#"> Tags List </a>
                                            </Link>
                                        </li>
