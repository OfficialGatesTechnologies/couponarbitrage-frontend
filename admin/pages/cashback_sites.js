...
export default withRouter(class Cashback_sites extends Component {
    ...
    getList = (page) => {
        ...
        let listUrl = apiUrl + 'admin/cashback-offer/site-list?pageLimit=' + pageLimit + '&page=' + page;
    ...
    updateSite = (action, id) => {
        ...
        if (updateStatus) {
            axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
            axios.post(apiUrl + 'admin/cashback-offer/update-site-status', {
                action: action,
                _id: id,
            }).then((result) => {
                ...
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li className="is-active"><a href="#">Cashback Sites  List</a></li>
                                    </ul>
                                    <Link href="/manage_cashback_sites">
                                        <a className="ad-new" >Add New Cashback Site</a>
                                    </Link>
                                </nav>
                    ...
                    <div className="box is-shadowless has-background-white" >
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Cashback Sites   List </h2>
                                <div>
                            ...
                            <table className="table is-bordered is-striped is-narrow is-hoverable is-fullwidth is-size-6">
                                <thead>
                                    <tr className="bg-light">
                                        ...
                                        <th onClick={this.handleSort.bind(this, 'name', this.state.sortOrder)} >Site Name   <i className={`fa ${(this.state.sortKey == "name") ? this.state.sortClass : "fa-sort"}`}></i></th>
                            ...
                            return <tr>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_cashback_sites?id=${dataRow._id}`} as={`/update_site/${dataRow._id}`}>
