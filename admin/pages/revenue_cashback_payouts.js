...
export default withRouter(class revenue_cashback_payouts extends Component {
    ...
    exportPayouts = (e) => {
        e.preventDefault();
        axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
        let listUrl = apiUrl + 'admin/cashback-payouts/export-payout?cb_type=3';
        axios.get(listUrl)
            .then(res => {
    ...
    render() {
        return (
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title>{site_name} - Revenue Share Cashback Payouts   </title>
                </Head>
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li className="is-active"><a href="#"> Revenue Share Cashback Payouts   List</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div className="box is-shadowless has-background-white" >
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Revenue Share Cashback Payouts   List </h2>
                                <div>
