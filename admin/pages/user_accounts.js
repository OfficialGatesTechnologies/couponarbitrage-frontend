                    ...
                    <div className="box is-shadowless has-background-white" >
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                ...
                                <div>
                                <a className="button is-link" onClick={this.resetSearch}>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_user_accounts?id=${dataRow._id}`} as={`/update-user/${dataRow._id}`}>
                                            <a className="button is-info is-small tooltip" data-tooltip="Edit">  <span className="icon has-text-white">
                                        ...
                                        <button onClick={props.updateAccount.bind(this, 'delete', dataRow._id)} className="button is-danger is-small tooltip" data-tooltip="Delete">
                                            <span className="icon has-text-white">
