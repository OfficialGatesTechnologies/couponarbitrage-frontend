...
export default withRouter(class Cashback_categories extends Component {
    ...
    getList = (page) => {
        ...
        let listUrl = apiUrl + 'admin/cashback-offer/list?pageLimit=' + pageLimit + '&page=' + page;
    ...
    render() {
        return (
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title>{site_name} - Cashback Category  </title>
                </Head>
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li className="is-active"><a href="#">Cashback Category  List</a></li>
                                    </ul>
                                    <Link href="/manage_cashback_categories">
                                        <a className="ad-new" >Add New Cashback Category</a>
                                    </Link>
                                </nav>
                    ...
                    <div className="box is-shadowless has-background-white" >
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Cashback Category   List </h2>
                                <div>
                            ...
                            return <tr>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_cashback_categories?id=${dataRow._id}`} as={`/update_cat/${dataRow._id}`}>
