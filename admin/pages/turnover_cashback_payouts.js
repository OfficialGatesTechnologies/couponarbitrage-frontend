...
export default withRouter(class revenue_cashback_payouts extends Component {
    ...
    getList = (page) => {
        ...
        let listUrl = apiUrl + 'admin/cashback-payouts/turnover-list?&pageLimit=' + pageLimit + '&page=' + page;
    ...
    handleRejectPayout = () => {
        ...
        if (updateStatus) {
            axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
            axios.post(apiUrl + 'admin/cashback-payouts/reject-turnover-payout', {
                _id: updateId,
                reason: reason
            }).then((result) => {
    ...
    exportPayouts = (e) => {
        e.preventDefault();
        axios.defaults.headers.common['Authorization'] = localStorage.getItem('jwtAdminToken');
        let listUrl = apiUrl + 'admin/cashback-payouts/export-turnover-payout';
        axios.get(listUrl)
            .then(res => {
                ...
                exportRes.map(function (dataRow) {
                    ...
                    exportRow['Affiliate_UserId'] = dataRow.cashback_user_id;
    ...
    render() {
        return (
            <div>
                <Head>
                    <meta charSet="utf-8" />
                    <title>{site_name} - Turnover Cashback  Payouts   </title>
                </Head>
                <div className="page-wrapper" id="page-wrapper">
                            ...
                            <div className="box bread-box is-shadowless has-background-white">
                                <nav className="breadcrumb" aria-label="breadcrumbs">
                                    <ul>
                                        ...
                                        <li className="is-active"><a href="#"> Turnover Cashback  Payouts   List</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div className="box is-shadowless has-background-white" >
                        ...
                        <div className="table-responsive dash-table-res">
                            <div className="level">
                                <h2 className="title is-size-5 has-text-grey-dark is-uppercase is-marginless">Turnover Cashback  Payouts   List </h2>
                                <div>
                        ...
                        props.arrlist.map(function (dataRow, i) {
                            ...
                            return <tr>
                                ...
                                <td>{dataRow.user_id ? dataRow.user_id.name : ''}
                                    <p><small>{dataRow.tb_type ? dataRow.tb_type.name : ''}  ID : {dataRow.cashback_user_id ? dataRow.cashback_user_id : ''}</small></p>
                                    
                                </td>
                                <td>{dataRow.user_id ? dataRow.user_id.username : ''}</td>
                                <td>£{dataRow.value ? dataRow.value.toFixed(2) : ''}</td>
                                ...
                                <td>
                                    <div className="buttons">
                                        ...
                                        <Link href={`/manage_turnover_cashback_payout?id=${dataRow._id}`} as={`/manage_turnover_cashback_payout/${dataRow._id}`}>
